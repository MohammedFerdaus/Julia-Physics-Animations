...
# A pendulum swings from a fixed pivot under gravity,
# losing energy each frame via a friction multiplier
# until it comes to rest at the vertical equilibrium.
#
# Physics:
...
# Pendulum geometry
const R_BOB = 20.0
const L_ROD = 200.0 # try 100, 200, 300
...
# Orbit ring (shows the arc the bob travels)
