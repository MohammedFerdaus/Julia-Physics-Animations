...
#  A reference cross and the orbit ellipse are drawn for context

# Ellipse parametric equations:
# x(θ) = cx + a·cos(θ)
# y(θ) = cy + b·sin(θ)
# where a = semi-major axis (horizontal) and
...
# Speed
const SPEED = 2.0   # degrees per frame

# Initial angles
# Start the two balls on opposite sides of the ellipse
